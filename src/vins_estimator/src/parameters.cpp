...
void readParameters(rclcpp::Node *n)
{
    ...
    {
        RCLCPP_WARN(rclcpp::get_logger("vins_est"), "have no prior about extrinsic param, calibrate extrinsic param");
    ...
    else 
    {
        ...
        {
            RCLCPP_WARN(rclcpp::get_logger("vins_est"), " Optimize extrinsic param around initial guess!");
            fsSettings["ex_calib_result_path"] >> EX_CALIB_RESULT_PATH;
            EX_CALIB_RESULT_PATH = VINS_FOLDER_PATH + EX_CALIB_RESULT_PATH;
        }
        if (ESTIMATE_EXTRINSIC == 0)
            RCLCPP_WARN(rclcpp::get_logger("vins_est"), " fix extrinsic param ");
        ...
        RCLCPP_INFO_STREAM(rclcpp::get_logger("vins_est"), "Extrinsic_R : " << std::endl << RIC[0]);
        RCLCPP_INFO_STREAM(rclcpp::get_logger("vins_est"), "Extrinsic_T : " << std::endl << TIC[0].transpose());
    } 
